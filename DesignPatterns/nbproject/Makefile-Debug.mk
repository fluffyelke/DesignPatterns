...
${OBJECTDIR}/Solid/DependencyInversionPrinciple/DependancyInversionPrinciple.o: Solid/DependencyInversionPrinciple/DependancyInversionPrinciple.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solid/DependencyInversionPrinciple/DependancyInversionPrinciple.o Solid/DependencyInversionPrinciple/DependancyInversionPrinciple.cpp
...
${OBJECTDIR}/Solid/InterfaceSegregationPrinciple/InterfaceSegregationPrinciple.o: Solid/InterfaceSegregationPrinciple/InterfaceSegregationPrinciple.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solid/InterfaceSegregationPrinciple/InterfaceSegregationPrinciple.o Solid/InterfaceSegregationPrinciple/InterfaceSegregationPrinciple.cpp
...
${OBJECTDIR}/Solid/LiskovSubstitutionPrinciple/LiskovSubstitutionPrinciple.o: Solid/LiskovSubstitutionPrinciple/LiskovSubstitutionPrinciple.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solid/LiskovSubstitutionPrinciple/LiskovSubstitutionPrinciple.o Solid/LiskovSubstitutionPrinciple/LiskovSubstitutionPrinciple.cpp
...
${OBJECTDIR}/Solid/OpenClosedPrinciple/Product.o: Solid/OpenClosedPrinciple/Product.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solid/OpenClosedPrinciple/Product.o Solid/OpenClosedPrinciple/Product.cpp
...
${OBJECTDIR}/Solid/SingleResponsibilityPrinciple/Journal.o: Solid/SingleResponsibilityPrinciple/Journal.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solid/SingleResponsibilityPrinciple/Journal.o Solid/SingleResponsibilityPrinciple/Journal.cpp
